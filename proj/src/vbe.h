...
#define VIDEO_CARD				0x10   /**< @brief vbe video card */

#define LINEAR_MODE		        BIT(14) /**< @brief linear model bit  */

#define PB2BASE(x)				(((x) >> 4) & 0x0F000) /**< @brief base of pb2 */
#define PB2OFF(x) 				((x) & 0x0FFFF)	/**< @brief offset of pb2 */


#define VBE_CALL_FAILED 		0x01 /**< @brief vbe call failed response */
#define VBE_UNSUPPORTED 		0x02 /**< @brief vbe unsupported function response */
#define VBE_INVALID_MODE 		0x03 /**< @brief vbe invalid mode response */

#define VBE_GAME_MODE			0x114	/**< @brief mode used for game 800x600 pixels */


#define VBE_CTRL_INFO			0x4F00 /**< @brief vbe control info function */
#define VBE_MODE_INFO			0x4F01 /**< @brief vbe mode info function */
#define VBE_SET_MODE			0x4F02 /**< @brief vbe set mode function */

#define VIDEO_MODE_END			0x0FFFF /**< @brief vbe end of video mode adress */
